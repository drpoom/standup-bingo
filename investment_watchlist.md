...
**Owner:** Uncle John (Dr. Poom)  
**Created:** 2026-04-05  
**Daily Briefing:** 7:00 AM Europe/Berlin  
**Search Method:** Ollama web search API (curl) - DuckDuckGo blocked by rate limits
...
| **Xiaomi** | Xiaomi Corporation | Consumer Electronics | China |
| **Trip.com** | Trip.com Group | Travel/Tourism | China |
...
- Industry reports (TrendForce, Gartner for semis)
- Regulatory filings (SEC, local exchanges)

---

## Notes

- Briefing delivered daily at 7:00 AM Europe/Berlin time
- Focus on material news: earnings, M&A, product launches, regulatory changes
- Skip minor price movements unless significant (>5% with catalyst)
